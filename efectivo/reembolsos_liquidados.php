...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Reembolsos efectuados</h1>
          <p>Aquí se encuentran los reembolsos que ya han sido realizados</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item">Reembolsos pagados</li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
                            ...
                            <td> 
                                ...
                                <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu">
                                    <a class="dropdown-item" href="elim_reemb.php?id=<?php echo $usuario['id_reembolso'];?>">Sí, eliminar reembolso</a>
                                    </div>
                                </div>
                            </td>
                          </tr>
