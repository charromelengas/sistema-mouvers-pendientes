...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pedidos pendientes por reembolsar</h1>
          <p>Aquí se encuentran los reembolsos que están pendientes por ser liquidados</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item">Reembolsos pendientes</li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                                <?php
                                   ...
                                   $consulta = "SELECT Re.id_reembolso, Us.nombre_usu, Re.ped_reemb, Re.fecha_reemb, Re.cant_reemb, Re.metodo_reemb, Re.motivo_reemb FROM reembolso Re 
                                   INNER JOIN usuario Us ON Re.id_usuario = Us.id_usuario
                                   WHERE id_sta = 2";
                          ...
                          <tr>
                            ...
                            <td><?php echo $usuario['ped_reemb']?> </td>
                            <td><?php echo $usuario['fecha_reemb']?> </td>
                            <td><?php echo $usuario['cant_reemb']?> </td>
                            <td><?php echo $usuario['metodo_reemb']?> </td>
                            <td><?php echo $usuario['motivo_reemb']?> </td>
                            <td>

                          <!--finalizar reembolso-->
                          <div class="btn-group">
                            <button type="button" class="btn btn-success"><i class="fa fa-check-circle-o" aria-hidden="true"></i></a></button>
                            <button type="button" class="btn btn-success dropdown-toggle dropdown-toggle-split" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                              <span class="sr-only">Toggle Dropdown</span>
                            </button>
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="fin_reemb.php?id=<?php echo $usuario['id_reembolso'];?>">Sí, finalizar reembolso</a>
                              </div>
                          </div>
