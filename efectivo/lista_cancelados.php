...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Lista de pedidos cancelados</h1>
          <p>Aquí se encuentran los pedidos que fueron cancelados. Favor de eliminarlos si ya fueron atendidos</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item">Pedidos cancelados</li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                                <?php
                                   ...
                                   $consulta = "SELECT Ca.id_cancel, Ca.fecha_cancel, Ca.num_pedi, Ca.sucursal, Ca.nom_clie, Ca.nom_rep,
                                   Ca.canti_cancel, Ca.observacion, Us.nombre_usu FROM cancelaciones Ca
                                   INNER JOIN usuario Us on Ca.id_usu = Us.id_usuario 
                                   WHERE id_stat = 2";
                          ...
                          <tr>
                            ...
                            <td><?php echo $usuario['fecha_cancel']?> </td>
                            <td><?php echo $usuario['sucursal']?> </td>
                            <td><?php echo $usuario['nom_clie']?> </td>
                            <td><?php echo $usuario['nom_rep']?> </td>
                            <td><?php echo $usuario['canti_cancel']?> </td>
                          ...
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="fin_can.php?id=<?php echo $usuario['id_cancel'];?>">Sí, eliminar cancelación</a>
                              </div>
                          </div>
