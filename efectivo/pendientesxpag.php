...
<html lang="en">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-th-list"></i> Pedidos pendientes por pagar</h1>
          <p>Aquí se encuentran los pedidos que están pendientes por ser liquidados</p>
        </div>
            ...
            <div class="tile-body">
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTable">
                  <thead>
                    <div><a class="btn btn-primary btn-sm" href="fpdf/busca_pendientesxpagar.php" target="blank"><i class="fa fa-file-pdf-o" aria-hidden="true"></i></a></div>
                    <tr>
                      <th>Encargado</th>
                      <th>Repartidor</th>
                      <th>Fecha</th>
                  ...
                  <tbody>
                                <?php
                                   ...
                                   $consulta = "SELECT Pe.id_pedido, Pe.nombre_rep, Pe.fecha, Pe.num_ped, Pe.cant_envio, Pe.observacion, 
                          ...
                          <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item" href="fin_ped.php?id=<?php echo $usuario['id_pedido'];?>">Sí, finalizar pedido</a>
                              </div>
                          </div>
